...
urlpatterns = [
    ...
    path('videostat/<int:topic>/stat/<int:stat>', views.videostat, name='videostat'),
    path('topictot/<int:lab_no>',views.topictot, name='topictot'),
    path('coursetot/<int:lab_no>',views.coursetot, name='coursetot'),
    ...
    path('<slug:course_name>/topics/', views.self_topic_index, name='topics'),
