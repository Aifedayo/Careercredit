...
export const environment = {
 ...
 //  API_URL:`http://stage.linuxjobber.com:4000/`,
  ...
  // WS_URL:`wss://e1s0jb46bg.execute-api.us-east-2.amazonaws.com/test`, //current
  // WS_URL:`wss://bbu3y2s1fd.execute-api.us-east-2.amazonaws.com/test`,
  WS_URL:`wss://krm5t4yyq9.execute-api.us-west-2.amazonaws.com/pro`,
